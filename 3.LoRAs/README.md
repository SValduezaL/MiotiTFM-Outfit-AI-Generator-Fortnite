...
Todos los LoRAs se entrenan sobre el modelo fine-tuned **`humanoid_05`**, que a su vez fue entrenado sobre **Stable Diffusion XL Base 1.0** (`sd_xl_base_1.0.safetensors`).
...
| ------------- | ------- | --------------------------------- | -------------- | ------ | ----- | ---- | ----- | ---- |
| **Animal**    | v3      | `Animal_v3-000012.safetensors`    | 42             | 15     | 4725  | 16   | 8     | 8e-5 |
| **Food**      | v8      | `Food_v8-000008.safetensors`      | 27             | 30     | 4050  | 16   | 8     | 8e-5 |
| **FuzzyBear** | v5      | `FuzzyBear_v5-000020.safetensors` | 8              | 20     | 4000  | 8    | 4     | 1e-4 |
| **Robots**    | v2      | `Robots_v2-000008.safetensors`    | 15             | 15     | 4500  | 8    | 4     | 1e-4 |
| **StarWars**  | v1      | `StarWars_v1-000013.safetensors`  | 19             | 20     | 3800  | 16   | 16    | 1e-4 |
...
-   Modelo base fine-tuned: `humanoid_05`
